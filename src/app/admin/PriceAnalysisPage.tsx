...
import { DollarSign, TrendingUp, TrendingDown, Info, Search, Filter } from "lucide-react";
...
export function PriceAnalysisPage() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    result.sort((a, b) => {
      ...
      const marginA = (a.price - (a.manufacturingCost + a.shippingCost + a.packagingCost)) / a.price;
      const marginB = (b.price - (b.manufacturingCost + b.shippingCost + b.packagingCost)) / b.price;
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full sm:w-64 bg-[#1E293B] border border-gray-800 text-white rounded-xl pl-10 pr-4 py-2.5 focus:outline-none focus:border-[#38BDF8] focus:ring-1 focus:ring-[#38BDF8] transition-all"
            />
          </div>
          <div className="relative">
            ...
            <select
              ...
              className="w-full sm:w-48 bg-[#1E293B] border border-gray-800 text-white rounded-xl pl-10 pr-8 py-2.5 focus:outline-none focus:border-[#38BDF8] focus:ring-1 focus:ring-[#38BDF8] transition-all appearance-none cursor-pointer"
            >
      ...
      {filteredProducts.length === 0 ? (
        <div className="p-10 text-center text-gray-400 bg-[#1E293B] rounded-2xl border border-gray-800">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="w-full bg-gray-800 rounded-full h-1.5">
                      <div className="bg-blue-400 h-1.5 rounded-full" style={{ width: `${Math.min((product.manufacturingCost / product.price) * 100, 100)}%` }}></div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="w-full bg-gray-800 rounded-full h-1.5">
                      <div className="bg-indigo-400 h-1.5 rounded-full" style={{ width: `${Math.min((product.shippingCost / product.price) * 100, 100)}%` }}></div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="w-full bg-gray-800 rounded-full h-1.5">
                      <div className="bg-purple-400 h-1.5 rounded-full" style={{ width: `${Math.min((product.packagingCost / product.price) * 100, 100)}%` }}></div>
                    </div>
                  </div>
                </div>
